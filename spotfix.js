...
var getDescription = function(objc){
    var arr = [];
    
    
    arr.push("<b>"+objc.description+"</b><br>");
    arr.push("<em>"+objc.hoursNeeded+" hours needed by "+objc.noOfPeople+" people </em><br>");
    arr.push("Initiated by "+objc.ownerName+"  and scheduled on <b>"+objc.soptFixDate.iso.substr(0,10)+"</b><br>");
    
    arr.push("<b>Address:</b> "+objc.addressOfTheFix==undefined?'Not Given':objc.addressOfTheFix);
    return arr.join("\n");
}
